...
-- Insert a test row into send_account_signing_key_added table
INSERT INTO send_account_signing_key_added (
    chain_id,
    log_addr,
    block_time,
    tx_hash,
...
SELECT results_eq(
        ...
        from activity
        where event_name = 'send_account_signing_key_added'
        and event_id = 'send_account_signing_key_added/send_account_signing_key_added/1/0/0'
    $$,
    $$
...
DELETE FROM send_account_signing_key_added
WHERE id in (
    SELECT id
