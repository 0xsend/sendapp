...
SELECT throws_ok(
    ...
    "User should not be able to delete directly from any 'auth_challenges' row or column."
);
...
SELECT throws_ok(
    ...
    "User should not be able to select directly into any 'auth_challenges' row or column."
);
