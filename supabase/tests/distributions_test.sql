...
INSERT INTO send_account_created(chain_id, log_addr, block_time, user_op_hash, tx_hash, account, ig_name, src_name, block_num, tx_idx, log_idx)
    VALUES (
        -- For bob
        8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xB0B0000000000000000000000000000000000000', 'send_account_created', 'send_account_created', 1, 0, 0),
    -- For alice
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000000', 'send_account_created', 'send_account_created', 2, 0, 0),
    -- For recipient1-4
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000001', 'send_account_created', 'send_account_created', 3, 1, 0),
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000002', 'send_account_created', 'send_account_created', 4, 2, 0),
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000003', 'send_account_created', 'send_account_created', 5, 3, 0),
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000004', 'send_account_created', 'send_account_created', 6, 4, 0),
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000005', 'send_account_created', 'send_account_created', 7, 4, 0),
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000006', 'send_account_created', 'send_account_created', 8, 4, 0),
(8453, '\xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', floor(extract(EPOCH FROM timestamptz '2013-07-01 12:00:00')), '\x1234', '\x1234', '\xa71ce00000000000000000000000000000000007', 'send_account_created', 'send_account_created', 9, 4, 0);
...
(tests.get_supabase_uid('recipient1'), '0xa71ce00000000000000000000000000000000001', 1, '\\x00112233445566778899AABBCCDDEEFF'),
(tests.get_supabase_uid('recipient2'), '0xa71ce00000000000000000000000000000000002', 1, '\\x00112233445566778899AABBCCDDEEFF'),
(tests.get_supabase_uid('recipient3'), '0xa71ce00000000000000000000000000000000003', 1, '\\x00112233445566778899AABBCCDDEEFF'),
(tests.get_supabase_uid('recipient4'), '0xa71ce00000000000000000000000000000000004', 1, '\\x00112233445566778899AABBCCDDEEFF'),
(tests.get_supabase_uid('recipient5'), '0xa71ce00000000000000000000000000000000005', 1, '\\x00112233445566778899AABBCCDDEEFF'),
(tests.get_supabase_uid('recipient6'), '0xa71ce00000000000000000000000000000000006', 1, '\\x00112233445566778899AABBCCDDEEFF'),
(tests.get_supabase_uid('recipient7'), '0xa71ce00000000000000000000000000000000007', 1, '\\x00112233445566778899AABBCCDDEEFF');
SELECT
...
SELECT
    set_config('role', 'service_role', TRUE);
INSERT INTO distributions(number, tranche_id, name, description, amount, hodler_pool_bips, bonus_pool_bips, fixed_pool_bips, qualification_start, qualification_end, hodler_min_balance, claim_end, chain_id)
    VALUES (123, 123, 'distribution #123', 'Description', 100000, 1000000, 1000000, 1000000,
        -- start now
        (
            SELECT
...
INSERT INTO send_slash(distribution_id, distribution_number, minimum_sends, scaling_divisor)
    VALUES ((
            ...
            WHERE
                number = 123), 123, 10, 1);
INSERT INTO public.distribution_verification_values(type, fixed_value, bips_value, distribution_id)
    VALUES ('tag_referral', 0, 500,(
            SELECT
                id
            FROM distributions
            WHERE
                number = 123));
INSERT INTO public.distribution_verification_values(type, fixed_value, bips_value, distribution_id)
    VALUES ('tag_registration', 10000, 0,(
            SELECT
                id
            FROM
                distributions
            WHERE
                number = 123));
INSERT INTO public.distribution_verification_values(type, fixed_value, bips_value, multiplier_max, multiplier_step, distribution_id)
    VALUES ('total_tag_referrals'::public.verification_type, 0, 0, 2.0, 0.02,(
            SELECT
                id
            FROM
                distributions
...
SELECT
    throws_ok($$ INSERT INTO distributions(number, tranche_id, name, description, amount, hodler_pool_bips, bonus_pool_bips, fixed_pool_bips, qualification_start, qualification_end, claim_end, chain_id)
            VALUES (1234, 1234, 'distribution #1234', 'Description', 100000, 1000000, 1000000, 1000000, '2023-01-01T00:00:00.000Z', '2023-01-31T00:00:00.000Z', '2023-02-28T00:00:00.000Z', 8453);
$$,
...
SELECT
    tests.clear_authentication();
SELECT
    throws_ok($$ INSERT INTO distribution_verification_values(distribution_id, type, fixed_value, bips_value)
            VALUES ((
                SELECT
                    id
                FROM distributions
...
SELECT
    throws_ok($$ INSERT INTO distribution_shares(distribution_id, user_id, address, amount, hodler_pool_amount, bonus_pool_amount, fixed_pool_amount)
            VALUES ((
                SELECT
                    id
                FROM distributions
...
SELECT
    set_config('role', 'service_role', TRUE);
INSERT INTO sendtag_checkout_receipts(chain_id, log_addr, tx_hash, ig_name, src_name, block_num, tx_idx, log_idx, block_time, abi_idx, sender, amount, referrer, reward)
    VALUES (8453, '\x5afe000000000000000000000000000000000000', '\x1234567890123456789012345678901234567890123456789012345678901234', 'sendtag_checkout_receipts', 'sendtag_checkout_receipts', 101, 0, 0, 1234567890, 0, '\xB0B0000000000000000000000000000000000000', 1, '\x0000000000000000000000000000000000000000', 0);
SELECT
...
SELECT
    set_config('role', 'service_role', TRUE);
INSERT INTO sendtag_checkout_receipts(chain_id, log_addr, tx_hash, ig_name, src_name, block_num, tx_idx, log_idx, block_time, abi_idx, sender, amount, referrer, reward)
    VALUES (8453, '\x5afe000000000000000000000000000000000000', '\x1234567890123456789012345678901234567890123456789012345678901234', 'sendtag_checkout_receipts', 'sendtag_checkout_receipts', 102, 0, 0, 1234567890, 0, '\xa71ce00000000000000000000000000000000000', 1, '\x0000000000000000000000000000000000000000', 0);
SELECT
    confirm_tags(ARRAY['alice']::citext[],(
            ...
            FROM sendtag_checkout_receipts
            WHERE
                sender = decode(substring('0xa71ce00000000000000000000000000000000000' FROM 3), 'hex')),(
            SELECT
                referral_code
...
INSERT INTO send_account_transfers(f, t, block_time, chain_id, tx_hash, ig_name, src_name, block_num, tx_idx, log_idx, abi_idx, v, log_addr)
    VALUES ('\xB0B0000000000000000000000000000000000000'::bytea, '\xa71ce00000000000000000000000000000000000'::bytea, EXTRACT(EPOCH FROM ((
                SELECT
                    qualification_start
                FROM distributions
                WHERE
...
INSERT INTO send_account_transfers(f, t, block_time, chain_id, tx_hash, ig_name, src_name, block_num, tx_idx, log_idx, abi_idx, v, log_addr)
    VALUES ('\xB0B0000000000000000000000000000000000000'::bytea, '\xa71ce00000000000000000000000000000000003'::bytea, EXTRACT(EPOCH FROM ((
                SELECT
                    qualification_start
                FROM distributions
                WHERE
...
INSERT INTO send_account_transfers(f, t, block_time, chain_id, tx_hash, ig_name, src_name, block_num, tx_idx, log_idx, abi_idx, v, log_addr)
    VALUES ('\xB0B0000000000000000000000000000000000000'::bytea, '\xa71ce00000000000000000000000000000000004'::bytea, EXTRACT(EPOCH FROM ((
                SELECT
                    qualification_start
                FROM distributions
                WHERE
...
INSERT INTO send_account_transfers(f, t, block_time, chain_id, tx_hash, ig_name, src_name, block_num, tx_idx, log_idx, abi_idx, v, log_addr)
    VALUES ('\xB0B0000000000000000000000000000000000000'::bytea, '\xa71ce00000000000000000000000000000000006'::bytea, EXTRACT(EPOCH FROM ((
                SELECT
                    qualification_start
                FROM distributions
                WHERE
        ...
        '\x5afe000000000000000000000000000000000000'::bytea),
('\xB0B0000000000000000000000000000000000000'::bytea,
    '\xa71ce0000000000000000000000000000069'::bytea,
    EXTRACT(EPOCH FROM ((
            SELECT
                qualification_start
            FROM distributions
