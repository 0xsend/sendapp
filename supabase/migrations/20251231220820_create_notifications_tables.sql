...
CREATE OR REPLACE FUNCTION "public"."upsert_web_push_token"(
    ...
    AS $$
BEGIN
    -- For web platform: token is NULL, endpoint contains the push endpoint
    INSERT INTO public.push_tokens (user_id, platform, token, endpoint, p256dh, auth)
    VALUES (p_user_id, 'web', NULL, p_endpoint, p_p256dh, p_auth)
...
ALTER FUNCTION "public"."upsert_web_push_token"("uuid", "text", "text", "text") OWNER TO "postgres";
GRANT EXECUTE ON FUNCTION "public"."upsert_web_push_token"("uuid", "text", "text", "text") TO "authenticated";
