drop function if exists "public"."contact_search"(p_query text, p_limit_val integer, p_offset_val integer, p_favorites_only boolean, p_label_ids bigint[], p_source_filter contact_source_enum[], p_include_archived boolean);
