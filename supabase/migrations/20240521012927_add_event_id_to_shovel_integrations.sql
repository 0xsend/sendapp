...
alter table send_account_created add column event_id text not null generated always as (
    ig_name
    || '/'
    || src_name
    || '/'
...
alter table send_account_transfers add column event_id text not null generated always as (
    ig_name
    || '/'
    || src_name
    || '/'
...
alter table send_token_transfers add column event_id text not null generated always as (
    ig_name
    || '/'
    || src_name
    || '/'
...
alter table send_revenues_safe_receives add column event_id text not null generated always as (
    ig_name
    || '/'
    || src_name
    || '/'
...
alter table send_account_signing_key_added add column event_id text not null generated always as (
    ig_name
    || '/'
    || src_name
    || '/'
...
alter table send_account_signing_key_removed add column event_id text not null generated always as (
    ig_name
    || '/'
    || src_name
    || '/'
