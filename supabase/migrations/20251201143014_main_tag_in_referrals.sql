...
CREATE OR REPLACE FUNCTION public.get_friends()
 RETURNS TABLE(avatar_url text, name text, sendid integer, x_username text, links_in_bio link_in_bio[], birthday date, tag citext, main_tag citext, created_at timestamp with time zone, is_verified boolean)
 LANGUAGE plpgsql
 SECURITY DEFINER
