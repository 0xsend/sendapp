...
CREATE OR REPLACE FUNCTION public.link_in_bio(profiles)
...
create type "public"."profile_lookup_result" as ("id" uuid, "avatar_url" text, "name" text, "about" text, "refcode" text, "x_username" text, "link_in_bio" jsonb, "birthday" date, "tag" citext, "address" citext, "chain_id" integer, "is_public" boolean, "sendid" integer, "all_tags" text[], "main_tag_id" bigint, "main_tag_name" text);
