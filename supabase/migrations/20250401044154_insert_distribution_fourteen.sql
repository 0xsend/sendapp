-- Round #14
-- 3m $send
-- Opens Apr 01st 00:00 UTC
-- Closes Apr 30th 23:59 UTC
-- 3k minimum
...
VALUES (
  14,
  'Distribution #14',
  'Fourteenth distribution of 10,000,000 SEND tokens to early hodlers',
  3000000000000000000000000, -- 3,000,000 SEND
  10000,
  0,
  10000,
  '2025-04-01T00:00:00Z' ::timestamp with time zone,
  '2025-05-01T00:00:00Z' ::timestamp with time zone - interval '1 second',
  3000000000000000000000, -- 3,000 SEND
  'infinity',
  8453, -- Base chain
...
LEAST(sa.created_at,(
    ...
    FROM distributions
    WHERE
      "number" = 14 LIMIT 1)) AS created_at
FROM
  send_accounts sa
WHERE
  sa.created_at <=(
...
SELECT
  calculate_and_insert_send_ceiling_verification(14);
