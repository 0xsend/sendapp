...
CREATE UNIQUE INDEX liquidity_pools_pool_addr_idx ON public.liquidity_pools USING btree(pool_addr);
...
CREATE UNIQUE INDEX swap_routers_router_addr_idx ON public.swap_routers USING btree(router_addr);
...
INSERT INTO public.swap_routers (router_addr)
VALUES ('0xc7d3ab410d49b664d03fe5b1038852ac852b1b29');
