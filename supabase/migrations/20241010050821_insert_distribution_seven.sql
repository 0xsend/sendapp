...
INSERT INTO public.distribution_verification_values(
  ...
  multiplier_step)
VALUES (
  'total_tag_referral' ::public.verification_type,
  0,
  0,
(
    SELECT
...
-- Add total_tag_referral to distribution_verifications
INSERT INTO public.distribution_verifications(
  distribution_id,
  user_id,
  type,
...
SELECT
  ...
  'total_tag_referral'::public.verification_type AS type,
  jsonb_build_object('total_referrals', tr.total_referrals) AS metadata,
