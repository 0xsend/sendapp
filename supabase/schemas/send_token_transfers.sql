...
CREATE INDEX "idx_send_token_transfers_f_block_time" ON "public"."send_token_transfers" USING "btree" ("f", "block_time");
CREATE INDEX "idx_send_token_transfers_t_block_time" ON "public"."send_token_transfers" USING "btree" ("t", "block_time");
