...
CREATE OR REPLACE FUNCTION "public"."link_in_bio"("public"."profiles") RETURNS SETOF "public"."link_in_bio"
    LANGUAGE "sql" STABLE
    AS $_$
    SELECT * FROM link_in_bio WHERE user_id = $1.id
$_$;

ALTER FUNCTION "public"."link_in_bio"("public"."profiles") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."link_in_bio"("public"."profiles") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."link_in_bio"("public"."profiles") TO "anon";
GRANT ALL ON FUNCTION "public"."link_in_bio"("public"."profiles") TO "authenticated";
GRANT ALL ON FUNCTION "public"."link_in_bio"("public"."profiles") TO "service_role";
