...
export type Database = {
  public: {
    ...
    Views: {
      activity_feed: {
        Row: {
          ...
          from_user: Database['public']['CompositeTypes']['activity_feed_user'] | null
          to_user: Database['public']['CompositeTypes']['activity_feed_user'] | null
        }
        Relationships: []
      }
      dashboard_metrics: {
      ...
      referrer: {
        Row: {
          ...
          id: string | null
          is_public: boolean | null
          links_in_bio: Database['public']['Tables']['link_in_bio']['Row'][] | null
          main_tag_id: number | null
    ...
    Enums: {
      ...
      temporal_status: 'initialized' | 'submitted' | 'sent' | 'confirmed' | 'failed'
      verification_type:
        | 'tag_registration'
        | 'tag_referral'
        | 'create_passkey'
  ...
  temporal: {
    ...
    Enums: {
      transfer_status: 'initialized' | 'submitted' | 'sent' | 'confirmed' | 'failed' | 'cancelled'
    }
    CompositeTypes: {
      [_ in never]: never
    }
