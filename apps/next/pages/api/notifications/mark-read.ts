 ...
 *   - Updates read_at timestamp and sets read = true for compatibility
...
export default async function handler(
  ...
  try {
    // Update read_at and read for matching notifications
    // Sets both read_at timestamp and read = true for backward compatibility
    ...
    if (updateError) {
      console.error('[Mark Read] Database error:', {
    ...
    console.error('[Mark Read] Unexpected error:', {
