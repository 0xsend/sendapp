...
export const getServerSideProps = guestOnlyGetSSP(async () => {
  ...
  const images = [
    await getPlaiceholderImage(`${remoteImagePath}/bg_image_dark_1.jpg${remoteImageQueryParams}`),
    await getPlaiceholderImage(`${remoteImagePath}/bg_image_dark_2.jpg${remoteImageQueryParams}`),
    await getPlaiceholderImage(`${remoteImagePath}/bg_image_dark_3.jpg${remoteImageQueryParams}`),
  ]
  return {
    props: {
      images,
