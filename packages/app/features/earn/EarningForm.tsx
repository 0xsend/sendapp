          ...
          {({ amount, areTermsAccepted }) => (
            <YStack gap={'$5'}>
              ...
              {parsedAmount > 0 ? (
                ...
                <CalculatedBenefits apy={10} monthlyEarning={10} rewards={3000} />
              ) : (
                <StaticBenefits />
              )}
      ...
      <YStack gap={'$3.5'}>
        ...
        <Card w={'100%'} p={'$5'} gap={'$7'} $gtLg={{ p: '$7' }}>
          <YStack gap={'$3.5'}>
            ...
            <YStack gap={'$2'}>
              <Row label={'Estimated Monthly Earning'} value={`${monthlyEarning} USDC`} />
              <Row label={'Rewards'} value={`${rewards} SEND`} />
            </YStack>
          </YStack>
        </Card>
      </YStack>
