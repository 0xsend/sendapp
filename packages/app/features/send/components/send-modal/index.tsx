import { Adapt, Button, Dialog, Image, Input, Label, ScrollView, Separator, Sheet, SizableText, Theme, XStack, YStack, styled } from "@my/ui"
...
export const SendModal = ({ sendAmount, asset, showModal, setShowModal }: ISendModalProps) => {
  return (
    <Theme name={'dark'}>
      <Dialog
        modal
      ...
      >
        ...
        <Dialog.Portal>
          ...
          >
            ...
            <ScrollView horizontal fg={0} mr={'$-6'}>
              {tags.map((tag, index) =>
                <YStack
                  key={`tag-${tag.name}`}
                  ai={'center'}
