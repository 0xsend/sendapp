// TODO: this page is duplicated of SearchBar.tsx, to avoid breaking changes in the activity tab
// after things done with both send and activity we need to merge both
