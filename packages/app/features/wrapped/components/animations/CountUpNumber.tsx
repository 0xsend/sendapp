...
export interface CountUpNumberProps extends Omit<ParagraphProps, 'children'> {
  /**
 ...
 *
 * Animates a number from 0 to a target value with a smooth counting effect.
 * Works cross-platform (web and native).
 * Uses React Native Animated API for smooth animations.
 *
 * @example
 * ```tsx
 * <CountUpNumber value={1000} duration={2000} />
 * <CountUpNumber value={42.5} decimals={1} />
 * <CountUpNumber value={1000000} formatter={(n) => n.toLocaleString()} />
 * ```
 */
