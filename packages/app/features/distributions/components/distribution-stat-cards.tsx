import { Card, CardProps, Paragraph, Progress, Spinner, XStack, YStack, H6, Text } from '@my/ui'
        ...
        >
          ...
          >
            ...
            <XStack ai="center" space="$2">
              ...
              <H6 size="$7" fontWeight={"700"}>{distributed}</H6>
            </XStack>
          </YStack>
          <YStack
            space="$2"
          ...
          >
            ...
            <XStack ai="center" space="$2">
              ...
              <H6 size="$7" fontWeight={"700"}>{DISTRIBUTION_INITIAL_POOL_AMOUNT.toLocaleString()}</H6>
            </XStack>
          </YStack>
        </XStack>
      </Card.Header >
  ...
  return (
    ...
    >
      <Card.Header f={1} jc="space-between">
        {hasDistribution ? (
          <Paragraph size={"$5"} theme="alt1">{subHeader}</Paragraph>
        ) : (
          <Paragraph size={"$5"} theme="alt1">No Active Distribution</Paragraph>
        )}
      </Card.Header>
      <YStack px="$2" pb="$4" space="$2" jc="center" f={1} zIndex={1} bc="transparent" $gtXs={{ px: "$4" }}>
        <YStack space="$4">
          <XStack f={1} space="$2" jc="center" ai="center" w="100%" >
            {/* days */}
            <Card f={1} py="$9" w="$6" h="$8" maw={"$10"} zIndex={1} bc="transparent" bordered bg={"#F0EEE9"} br={"$6"} $gtXs={{
              br: '$8'
            }}>
