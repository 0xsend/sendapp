    ...
    const startPulseAnimation = useCallback(() => {
      ...
      pulseOpacity.value = withRepeat(
        withSequence(
          ...
          withDelay(pulseDelay, withTiming(pulseStartOpacity, { duration: 0 }))
        ),
        -1,
        true
      )
      pulseScale.value = withRepeat(
        withSequence(
          withTiming(pulseEndScale, { duration: pulseDuration }),
          withDelay(pulseDelay, withTiming(1, { duration: 0 }))
        ),
        -1,
        true
      )
