...
import * as RLV from 'recyclerlistview/web'
...
export const dataProviderMaker = <T = never>(
  ...
  const dataProvider = new RLV.DataProvider(rowHasChanged, getStableId)
...
export const layoutProviderMaker = (options: {
  ...
  return new RLV.GridLayoutProvider(maxSpan, getLayoutType, getSpan, getHeightOrWidth)
}

export const RecyclerList = RLV.RecyclerListView
