...
contract DaimoEphemeralNotes {
    ...
    function claimNote(address _ephemeralOwner, bytes memory _signature) external {
        ...
        require(
            signer == _ephemeralOwner || msg.sender == note.from, "EphemeralNotes: invalid signature and not creator"
        );
