...
contract DaimoPaymasterV2 is BasePaymaster {
    ...
    function setBundlerWhitelist(address[] calldata addresses, bool isWhitelisted) public onlyOwner {
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        return (abi.encode(userOp.maxFeePerGas, userOp.maxPriorityFeePerGas), 0);
    }
