...
export interface PublicKeyCredentialCreationOptionsSerialized extends Omit<PublicKeyCredentialCreationOptions, 'challenge' | 'user'> {
    challenge: string;
...
export interface AuthenticatorAttestationResponseSerialized extends Omit<AuthenticatorAttestationResponse, 'clientDataJSON' | 'attestationObject'> {
    clientDataJSON: string;
    attestationObject: string;
}
export interface PublicKeyCredentialAttestationSerialized extends Omit<PublicKeyCredential, 'response' | 'rawId'> {
...
export interface PublicKeyCredentialRequestOptionsSerialized extends Omit<PublicKeyCredentialRequestOptions, 'challenge' | 'allowCredentials'> {
    challenge: string;
...
export interface AuthenticatorAssertionResponseSerialized extends Omit<AuthenticatorAssertionResponse, 'clientDataJSON' | 'authenticatorData' | 'signature' | 'userHandle'> {
    clientDataJSON: string;
    authenticatorData: string;
    signature: string;
    userHandle: string | null;
}
export interface PublicKeyCredentialAssertionSerialized extends Omit<PublicKeyCredential, 'response' | 'rawId'> {
