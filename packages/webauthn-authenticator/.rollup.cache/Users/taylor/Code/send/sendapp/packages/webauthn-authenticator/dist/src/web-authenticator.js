 ...
 */
function createWebauthnCredential({ rpId = 'localhost', userHandle = null, }) {
 ...
 */
function getWebauthnCredential({ credentialId, rpId = 'localhost', }) {
 ...
 */
export async function createPublicKeyCredential(credentialOptions) {
    ...
    const clientDataJSON = base64.encode(new TextEncoder().encode(JSON.stringify({
 ...
 */
export async function getPublicKeyCredential(credentialRequestOptions) {
    ...
    const clientDataBuffer = Buffer.from(new TextEncoder().encode(JSON.stringify({
        challenge: base64.encode(challenge),
 ...
 */
function generateAuthenticatorData(rpId, counter, attestedCredentialData) {
 ...
 */
function generateAttestedCredentialData(credentialId, publicKey) {
 ...
 * @see https://www.w3.org/TR/webauthn-2/#sctn-generating-an-attestation-object
 */
function generateAttestionObject(authData, clientDataJSON, privateKey) {
 ...
 */
function generateAssertionObject(authData, clientDataJSON, privateKey) {
