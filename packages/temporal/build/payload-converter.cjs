...
var payload_converter_exports = {};
__export(payload_converter_exports, {
  payloadConverter: () => payloadConverter
});
module.exports = __toCommonJS(payload_converter_exports);
var import_common2 = require("@temporalio/common");

// src/superjson-payload-converter.ts
...
// src/superjson-payload-converter.ts
var import_encoding = require("@temporalio/common/lib/encoding");
var SuperjsonPayloadConverter = class {
  ...
  toPayload(value) {
    ...
    return {
      metadata: {
        [import_common.METADATA_ENCODING_KEY]: (0, import_encoding.encode)("json/plain"),
        // Include an additional metadata field to indicate that this is an SuperJSON payload
        format: (0, import_encoding.encode)("extended")
      },
      data: (0, import_encoding.encode)(sjson)
    };
  }
  fromPayload(content) {
    try {
      ...
      return SuperJSON.parse((0, import_encoding.decode)(content.data));
    } catch (e) {
      throw new UnsupportedSuperjsonTypeError(
        `Can't run SUPERJSON.parse on this value: ${content.data}. Either convert it (or its properties) to SUPERJSON-serializable values (see https://github.com/flightcontrolhq/superjson#readme ), or create a custom data converter. SJSON.parse error message: ${errorMessage(
          e
        )}`,
        e
      );
...
var UnsupportedSuperjsonTypeError = class extends import_common.PayloadConverterError {
...
// src/payload-converter.ts
var payloadConverter = new import_common2.CompositePayloadConverter(
  new import_common2.UndefinedPayloadConverter(),
